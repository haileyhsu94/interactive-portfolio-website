import svgPaths from "./svg-026xdhw237";
import imgHeroImage from "figma:asset/da977139d3e22fa82d2011e6c47e87e55660646a.png";
...
function HeroImage() {
  return (
    <div
      className="[grid-area:1_/_1] bg-center bg-cover bg-no-repeat h-[212px] ml-0 mt-0 rounded-br-[20px] rounded-tr-[20px] shadow-[-79px_105px_2px_-104px_#e6ff02,81px_105px_2px_-104px_#e6ff02] w-[369px]"
...
function Group9() {
  return (
    <div className="basis-0 grid-cols-[max-content] grid-rows-[max-content] grow inline-grid leading-[0] min-h-px min-w-px place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] h-[138px] ml-[63px] mt-9 relative w-[236px]" data-name="glow">
        <div className="absolute inset-[-72.46%_-42.37%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 436 338">
            <g filter="url(#filter0_f_3_588)" id="glow">
              <ellipse cx="218" cy="169" fill="var(--fill-0, #E6FF02)" rx="118" ry="69" />
            </g>
            <defs>
              <filter
              ...
              >
                ...
                <feGaussianBlur result="effect1_foregroundBlur_3_588" stdDeviation="50" />
              </filter>
            </defs>
          </svg>
        </div>
