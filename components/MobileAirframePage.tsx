...
export default function MobileAirframePage({ onBack, openProjects, onCloseProject, onNavigateToProject, onLogoClick }: AirframePageProps) {
  ...
  return (
    <div className="h-screen bg-neutral-950 text-white w-full overflow-hidden">
      ...
      />
      <div className="box-border content-stretch flex flex-row gap-4 items-stretch justify-start p-[12px] relative w-full min-w-0 pt-[84px] lg:pt-[12px] h-[calc(100vh-146px)] lg:h-[calc(100vh-74px)]">
        {/* Sidebar */}
